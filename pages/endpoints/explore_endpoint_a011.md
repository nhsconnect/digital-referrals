...
| ------------------ | ------ |
| FIELD_NOT_PERMITTED | A _referring clinician_ *is* provided when the logged in user is *not* an RCA, or: a _referrer right override comment_ *is* provided when none of the shortlisted services is marked as unaccredited|
...
| VALUE_IS_REQUIRED | A _referring clinician_ is *not* provided when the logged in user *is* an RCA, or: a _referrer right override comment_ is *not* provided when one or more of the shortlisted services is marked as unaccredited |

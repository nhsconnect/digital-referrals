...
# OUTPUT
## Response: Success
If successful, the status code `201 (Created)` is returned and the response body contains the just created [eRS-ReferralRequest-1](https://fhir.nhs.uk/STU3/StructureDefinition/eRS-ReferralRequest-1), the API will also create a triage request to that service.
...
```http
"X_ERS_TRANSACTION_ID" : "505d58b8-137c-4738-ba84-f27bed651b26-1",
"ETag" : "W/\"3\"",
